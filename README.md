...
| :--- | :--- | :--- |
| **Max Frequency ($F_{max}$)** | [cite_start]1.232 GHz [cite: 382] | [cite_start]548.5 MHz [cite: 399] |
| **Critical Path Delay ($t_{pd,max}$)** | [cite_start]0.594 ns [cite: 379] | [cite_start]1.503 ns [cite: 399] |
| **Setup Time ($t_{su}$)** | [cite_start]0.11 ns [cite: 174] | [cite_start]0.32 ns [cite: 399] |
| **Hold Time ($t_{h}$)** | [cite_start]0 ns [cite: 190] | [cite_start]0 ns [cite: 399] |
...
[cite_start]The adder logic follows these fundamental Boolean definitions for $i=1$ to $5$[cite: 18]:
...
## ## Verification
1.  [cite_start]**NGSPICE Simulation**: Functional verification confirmed the adder works for all test cases, including worst-case scenarios like $10011 + 10001 = 100100$[cite: 87, 88].
2.  [cite_start]**Verilog HDL**: A structural description was used to verify the synchronous pipeline latency of one clock cycle[cite: 440, 467].
...
## ## Project Structure
* [cite_start]`/Schematic`: NGSPICE netlists and simulation results[cite: 330, 332].
...
* [cite_start]`/Stick_Diagrams`: Abstract representations of the physical material layers[cite: 200, 201].
